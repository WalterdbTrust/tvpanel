sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("tvpanel/app", ".html");
		...
		return Opa5.extend("tvpanel.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["tvpanel/localService/mockserver"], function (mockserver) {
