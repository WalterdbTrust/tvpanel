sap.ui.define(["jquery.sap.global", "sap/ui/core/Control", "google.maps", "openui5/googlemaps/MapUtils", "./Animation"], function(t, i, e,
	n, o) {
	"use strict";
	...
	return s.prototype.init = function() {
		...
		this.marker && null !== this.getLat() && null !== this.getLng() && (t.sap.clearDelayedCall(this.delayedCallId), this.delayedCallId = t
		...
		this.marker || (this.marker = this.createMarker(), this.addListener(this.marker, "click", this.onClick.bind(this))), this.getDraggable() &&
			this.addListener(this.marker, "dragend", this.onDragEnd.bind(this)), this.marker.setMap(this.map), this.marker.setOptions(this.getOptions()),
			"function" == typeof this.marker.setZIndex && this.marker.setZIndex(this.getZIndex()), this.infoWindow || (this.infoWindow = new e.InfoWindow({
		...
		var t = {};
		return t.position = new e.LatLng(this.getLat(), this.getLng()), t.draggable = this.getDraggable(), t.animation = this.getAnimation(),
			t.visible = this.getVisible(), t.icon = this.getIcon(), t
